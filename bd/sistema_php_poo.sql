...
('10123123', 'Usuario de pruebas', '202cb962ac59075b964b07152d234b70', 'S', 'L', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'E'),
('99009009', 'Usuario Administrativo', '202cb962ac59075b964b07152d234b70', 'S', 'E', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X');
