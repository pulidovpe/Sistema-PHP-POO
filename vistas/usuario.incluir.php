<?php 
	...
	*/
	...
	$personalinc2 = "index.php?cnt=Usuario&act=grabar";
					...
					<table width="330" border="0" align="center">
						<tr>
							<td colspan="2" align="center">
								...
								<!-- button type="button" onclick=" location='index.php?cnt=Usuario&act=grabar' ">Grabar</button -->
